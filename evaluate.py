...
if __name__ == "__main__":
    ...
    parser.add_argument("--gold", "-g", type=Path, default="./data/gold.json", help="Path to the gold standard file")
    parser.add_argument("--output_type", "-o", type=Path, default="dspy", help="Type of output to validate: dspy or baml")
    args = parser.parse_args()

    data_path = Path("./data")
    gold_file = data_path / "gold.json"
    result_file = data_path / f"structured_output_{args.output_type}.json"
